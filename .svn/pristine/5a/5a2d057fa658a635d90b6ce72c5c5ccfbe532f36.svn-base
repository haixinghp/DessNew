...
typedef enum
{
  ...
  /*-------其他类菜单---------*/
	...
	/*-------二级菜单(半自动款)---------*/
	EM_MENU_ADD_USER,		//增加用户菜单
	EM_MENU_DELETE_USER,		// 删除用户菜单
	EM_MENU_SYSTEM_TIME_SETTING,		//系统时间设置菜单
	EM_MENU_UNLOCK_WAY_SETTING,		// 开锁方式设置菜单
	EM_MENU_VOICE_SETTING,		//语音设置菜单
	
	/*-------三级菜单(半自动款)---------*/
	EM_MENU_FINGER_DELETE_GUEST,      //删除普通用户指纹
	
	/*-------IC卡菜单---------*/
    EM_MENU_CARD_ADD,          //增加卡
	EM_MENU_CARD_DELETE,            //删除卡
	EM_MENU_CARD_CHECK_ERR,         //卡验证失败
