...
#ifndef __NZ3801_A_COM_H_
#define __NZ3801_A_COM_H_
...
#define  REG1CH          0x1C    //Contains settings, TxWait settings and MIFARE halted mode bit.
