...
#ifndef __NZ3801_AB_COM_H_
#define __NZ3801_AB_COM_H_
...
#define  COMMAND_AUTOCOLL      0x0D /*Activates automatic anticollision in Target mode. Data from Config command is used.
                           Remark: </strong>Activate CRC before,( does it's own settings for CRC)*/
...
******************************************************************************		
*/
extern void nzWriteReg(uint8_t reg, uint8_t value);
extern uint8_t   nzReadReg(uint8_t reg);
extern void nzSetBitMask(uint8_t reg,uint8_t mask);
extern void nzClearBitMask(uint8_t reg,uint8_t mask);
extern void nzSetRegExt(uint8_t extRegAddr,uint8_t extRegData);
extern void nzClearFifo(void);
extern void nzClearFlag(void);
extern void nzStartCmd(uint8_t cmd);
